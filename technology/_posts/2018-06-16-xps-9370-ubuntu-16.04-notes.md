...
My laptop has 16GB of memory, a 512GB SSD, and the QHD+ touchscreen.
...
The fan rattles badly at low RPM. I suspect this will eventually require warranty replacement.

The 1 key is not backlit. Actually it's just the 1 that's dark; the ! is backlit. This doesn't really bother me.
...
_Note: As of June 2018, the BIOS had default settings to "trust" the Dell Thunderbolt docks, which seems to have solved a lot of docking problems earlier users had._

# Software / Application Issues

## Ubuntu

I updated Ubuntu packages immediately `sudo apt update` and `sudo apt upgrade`. There were _many_ upgrades available, right out of the box, including a newer kernel. Now running 4.13.0-45.
...
Atom needed the atom-touch-events package to be installed.
