...
My laptop has 16GB of memory, a 512GB SSD, and the QHD+ touchscreen. I dock at work with the TB16 dock to my old 27" Apple Thunderbolt Display. My laptop was manufactured in June 2018. Depending on manufacture date, some of the problems below may not exist, or have different solutions.
...
In the Display system settings, there should be a "scale factor for menu and title bars" slider. Mine was set at 1 and I changed it to 2. Many apps will simply honor that setting. However, not all of them will, hence the sections below for specific apps.
